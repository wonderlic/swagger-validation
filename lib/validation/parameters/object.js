...
var validateObject = function(param, value, models) {
  ...
  // validate the model if this isn't a "generic" object
...
var validate = function(param, value, models) {
  return (param.type === "object" || models.hasOwnProperty(param.type)) ? validateObject(param, value, models) : helper.errorReturn('Unknown param type %s', param.type);
};
