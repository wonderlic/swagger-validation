...
var validateNumber = function(param, value) {
  ...
  // Calling parseFloat inadvertently casts empty arrays / booleans to 0, so checking if value is an array / boolean explicitly.
  var val = parseFloat(value);
  if (isNaN(val) || !isFinite(val) || _.isArray(value) || _.isBoolean(value)) {
