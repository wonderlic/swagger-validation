...
var validateInteger = function(param, value) {
  ...
  // Calling Number constructor inadvertently casts empty arrays / booleans / whitespace-strings 
  // to 0, so checking if value is an array / boolean / whitespace-string explicitly.
