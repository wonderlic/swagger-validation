 ...
 * This allows all forms of a number (so 2, 2.0, 2.2, 2e0, 0x2). As a hex value COULD be the hex representation
...
var validateInteger = function(param, value) {
  ...
  // Constructing a Number inadvertently casts empty arrays / booleans to 0, so checking if value is an array / boolean explicitly.
  var val = Number(value);
  if (!Number.isInteger(val) || _.isArray(value) || _.isBoolean(value)) {
