...
/**
 * Used by the {@link Validation.Parameters} to determine whether or not a particular <tt>value</tt> is required.
 * 
 * @memberOf Validation.Parameters
 * @method Is_Required
...
function isRequired(param, value) {
  if (_.isUndefined(value) || _.isNull(value) || value === '') {
    ...
    return isParamRequired ? errorReturn("%s is required", param.name) : [];
  }
  return;
}