 ...
 */
var validateParamType = function(param, req, models) {
  switch (param.paramType.toLowerCase()) {
    case 'q':
    case 'query':
      return paramTypes.query(param, req, models);
    case 'path':
      return paramTypes.path(param, req, models);
    case 'body':
      return paramTypes.body(param, req, models);
    case 'form':
      return paramTypes.form(param, req, models);
    case 'header':
      return paramTypes.header(param, req, models);
  }
};
