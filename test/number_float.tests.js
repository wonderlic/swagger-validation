...
describe('number - float', function() {
  ...
  it('should validate with minimum', function() {
    var value = 1;
    var ret = validate(helper.makeNumberParam('number', false, 'float', '0'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should validate with minimum with decimal', function() {
    var value = 1.2356;
    var ret = validate(helper.makeNumberParam('number', false, 'float', '1.23'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should validate with maximum', function() {
    var value = 1;
    var ret = validate(helper.makeNumberParam('number', false, 'float', null, '10'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should validate with maximum with decimal', function() {
    var value = 1.42;
    var ret = validate(helper.makeNumberParam('number', false, 'float', null, '1.426541323432'), value);
    helper.validateSuccess(ret, 1, [value]);
  });
  ...
  it('should validate with minimum inclusive with decimal', function() {
    var value = 1.2356895;
    var ret = validate(helper.makeNumberParam('number', false, 'float', '1.2356895'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should validate with maximum inclusive', function() {
    var value = 32465;
    var ret = validate(helper.makeNumberParam('number', false, 'float', null, '32465'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should validate with maximum inclusive with decimal', function() {
    var value = 8569.26652323;
    var ret = validate(helper.makeNumberParam('number', false, 'float', null, '8569.26652323'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should validate with minimum and maximum', function() {
    var value = 3246;
    var ret = validate(helper.makeNumberParam('number', false, 'float', '321', '32465'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should not validate with minimum', function() {
    var value = -4563.23565632;
    var ret = validate(helper.makeNumberParam('number', false, 'float', '-2.32333'), value);
    helper.validateError(ret, 1, ["testParam is below the minimum value"]);
  });

  it('should not validate with maximum', function() {
    var value = 11.26535;
    var ret = validate(helper.makeNumberParam('number', false, 'float', null, '10.278974132'), value);
  ...
  it('should not validate with required field null', function() {
    var value = null;
    var ret = validate(helper.makeNumberParam('number', true, 'float'), value);
    helper.validateError(ret, 1, ["testParam is required"]);
  });

  it('should not validate with required field undefined', function() {
    var ret = validate(helper.makeNumberParam('number', true, 'float'), undefined);
    helper.validateError(ret, 1, ["testParam is required"]);
  });
  ...
  it('should not validate with true boolean', function() {
    var value = true;
    var ret = validate(helper.makeNumberParam('number', false, 'float'), value);
    helper.validateError(ret, 1, ["testParam is not a type of float"]);
  });
