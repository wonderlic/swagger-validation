...
describe('set', function() {
  ...
  it('should validate with number with float format', function() {
    var ret = validate(helper.makeArrayParam(false, 'number', 'float', true), [1, '2.0']);
    helper.validateSuccess(ret, 0);
  });

  it('should validate with number with double format', function() {
    var ret = validate(helper.makeArrayParam(false, 'number', 'double', true), [1.265, '2.2352', 2e0, 0x88]);
    helper.validateSuccess(ret, 0);
  });

  it('should validate with integer with no format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', null, true), ['1', '2']);
    helper.validateSuccess(ret, 0);
  });

  it('should validate with integer with int32 format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', 'int32', true), [1, '2.0']);
    helper.validateSuccess(ret, 0);
  });

  it('should validate with integer with int64 format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', 'int64', true), [1.265, '2.2352', 2e0, 0x88]);
    helper.validateSuccess(ret, 0);
  });
  ...
  it('should validate with string with byte format', function() {
    var ret = validate(helper.makeArrayParam(false, 'string', 'byte', true), [65, 35, 23]);
    helper.validateSuccess(ret, 0);
  });

  it('should validate with string with date format', function() {
    var ret = validate(helper.makeArrayParam(false, 'string', 'date', true), ['8-9-2014', '1-1-1970']);
    helper.validateSuccess(ret, 0);
  });

  it('should validate with string with date-time format', function() {
    var ret = validate(helper.makeArrayParam(false, 'string', 'date-time', true), ['8-9-2014 12:00AM', '1-1-1970 1:32PM']);
    helper.validateSuccess(ret, 0);
  });
  ...
  it('should validate with simple objects', function() {
    ...
    var ret = validate(helper.makeArrayParam(false, 'Test', null, true), [
      { id: 1.23 },
      { id: 1.23 },
      { id: 1.23 }
    ], model);
  ...
  it('should validate with object inheritance', function() {
    ...
    var ret = validate(helper.makeArrayParam(false, 'baz', null, true), [
      {
        number: 0x33,
        float: -2.231231,
  ...
  it('should not validate with required field null', function() {
    var ret = validate(helper.makeArrayParam(true, 'string', null, true), null);
    helper.validateError(ret, 1, ["testParam is required"]);
  });

  it('should not validate with required field undefined', function() {
    var ret = validate(helper.makeArrayParam(true, 'number', null, true), undefined);
    helper.validateError(ret, 1, ["testParam is required"]);
  });

  it('should not validate with required field empty string', function() {
    var ret = validate(helper.makeArrayParam(true, 'integer', null, true), '');
    helper.validateError(ret, 1, ["testParam is required"]);
  });

  it('should not validate with empty object', function() {
    var ret = validate(helper.makeArrayParam(false, 'boolean', null, true), {});
  ...
  it('should not validate with one error with number with no format', function() {
    var ret = validate(helper.makeArrayParam(false, 'number', null, true), ['1', 'thisisastring']);
  ...
  it('should not validate with one error with number with float format', function() {
    var ret = validate(helper.makeArrayParam(false, 'number', 'float', true), [1, 'thisisastring']);
  ...
  it('should not validate with one error with number with double format', function() {
    var ret = validate(helper.makeArrayParam(false, 'number', 'double', true), [1.265, '2.2352', 2e0, 0x88, 'thisisastring']);
  ...
  it('should not validate with one error with integer with no format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', null, true), ['1', '2', 'thisisastring']);
  ...
  it('should not validate with one error with integer with int32 format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', 'int32', true), [1, '2.0', 'thisisastring']);
  ...
  it('should not validate with one error with integer with int64 format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', 'int64', true), [1.265, '2.2352', 2e0, 0x88, 'thisisastring']);
  ...
  it('should not validate with one error with string with no format', function() {
    var ret = validate(helper.makeArrayParam(false, 'string', null, true), ['These', 'are', 'a', 'lot', 'of', 'strings', 1]);
  ...
  it('should not validate with two errors with number with no format', function() {
    var ret = validate(helper.makeArrayParam(false, 'number', null, true), ['1', 'thisisastring', 'thisisalsoastring']);
  ...
  it('should not validate with two errors with number with float format', function() {
    var ret = validate(helper.makeArrayParam(false, 'number', 'float', true), [1, 'thisisastring', 'thisisalsoastring']);
  ...
  it('should not validate with two errors with number with double format', function() {
    var ret = validate(helper.makeArrayParam(false, 'number', 'double', true), [1.265, '2.2352', 2e0, 0x88, 'thisisastring', 'thisisalsoastring']);
  ...
  it('should not validate with two errors with integer with no format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', null, true), ['1', '2', 'thisisastring', 'thisisalsoastring']);
  ...
  it('should not validate with two errors with integer with int32 format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', 'int32', true), [1, '2.0', 'thisisastring', 'thisisalsoastring']);
  ...
  it('should not validate with two errors with integer with int64 format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', 'int64', true), [1.265, '2.2352', 2e0, 0x88, 'thisisastring', 'thisisalsoastring']);
  ...
  it('should not validate with two errors with string with no format', function() {
    var ret = validate(helper.makeArrayParam(false, 'string', null, true), ['These', 'are', 'a', 'lot', 'of', 1, true, 'strings']);
  ...
  it('should not validate with non-uniqueness with number with no format', function() {
    var ret = validate(helper.makeArrayParam(false, 'number', null, true), ['1', 1]);
  ...
  it('should not validate with non-uniqueness with number with float format', function() {
    var ret = validate(helper.makeArrayParam(false, 'number', 'float', true), [11.23213, '11.23213']);
    helper.validateError(ret, 1, ["testParam is not unique. This may lead to an unintended loss of data"]);
  });

  it('should not validate with non-uniqueness with number with double format', function() {
    var ret = validate(helper.makeArrayParam(false, 'number', 'double', true), [1.265, '2.2352', 2e0, 0x88, 2]);
    helper.validateError(ret, 1, ["testParam is not unique. This may lead to an unintended loss of data"]);
  });

  it('should not validate with non-uniqueness with integer with no format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', null, true), ['1', '2', 1]);
    helper.validateError(ret, 1, ["testParam is not unique. This may lead to an unintended loss of data"]);
  });

  it('should not validate with non-uniqueness with integer with int32 format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', 'int32', true), [1, '2.0', 2e0]);
    helper.validateError(ret, 1, ["testParam is not unique. This may lead to an unintended loss of data"]);
  });

  it('should not validate with non-uniqueness with integer with int64 format', function() {
    var ret = validate(helper.makeArrayParam(false, 'integer', 'int64', true), [1.265565, '2.2352', 2e0, 0x88, '1.265565']);
    helper.validateError(ret, 1, ["testParam is not unique. This may lead to an unintended loss of data"]);
  });

  it('should not validate with non-uniqueness with string with no format', function() {
    var ret = validate(helper.makeArrayParam(false, 'string', null, true), ['These', 'are', 'a', 'lot', 'of', 'strings', 'strings']);
    helper.validateError(ret, 1, ["testParam is not unique. This may lead to an unintended loss of data"]);
  });
