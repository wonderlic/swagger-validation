...
describe('integer', function() {
  it('should validate', function() {
    var value = 1;
    var ret = validate(helper.makeNumberParam('integer', false), value);
  ...
  it('should validate with minimum', function() {
    var value = 1;
    var ret = validate(helper.makeNumberParam('integer', false, null, '0'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should validate with maximum', function() {
    var value = 1;
    var ret = validate(helper.makeNumberParam('integer', false, null, null, '10'), value);
    helper.validateSuccess(ret, 1, [value]);
  });
  ...
  it('should validate with maximum inclusive', function() {
    var value = 32465;
    var ret = validate(helper.makeNumberParam('integer', false, null, null, '32465'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should validate with minimum and maximum', function() {
    var value = 3246;
    var ret = validate(helper.makeNumberParam('integer', false, null, '321', '32465'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should not validate with minimum', function() {
    var value = -4563;
    var ret = validate(helper.makeNumberParam('integer', false, null, '-2'), value);
  ...
  it('should not validate with required field null', function() {
    var value = null;
    var ret = validate(helper.makeNumberParam('integer', true), value);
    helper.validateError(ret, 1, ["testParam is required"]);
  });

  it('should not validate with required field undefined', function() {
    var ret = validate(helper.makeNumberParam('integer', true), undefined);
    helper.validateError(ret, 1, ["testParam is required"]);
  });
  ...
  it('should not validate with true boolean', function() {
    var value = true;
    var ret = validate(helper.makeNumberParam('integer', false), value);
    helper.validateError(ret, 1, ["testParam is not a type of integer"]);
  });
